...
public class Editor extends Application {
    ...
    private class KeyEventHandler implements EventHandler<KeyEvent> {
        ...
        private String listToString() {
            String allTypedChars = "";
            for (String characterTyped : characterTypedList) {
                allTypedChars += characterTyped;
            }
            return allTypedChars;
        }
        ...
        public void handle(KeyEvent keyEvent) {
            if (keyEvent.getEventType() == KeyEvent.KEY_TYPED) {
                ...
                if (characterTyped.length() > 0) {
                    ...
                    characterTypedList.addLast(characterTyped);
                    displayText.setText(listToString());
                    keyEvent.consume();
                }
                topLeftText();
        ...
        private void topLeftText() {
            ...
            // Calculate the position so that the text will be top-left on the screen.
            double textTop = 0;
            double textLeft = 0;

            // Re-position the text.
            displayText.setX(textTop);
            displayText.setY(textLeft);
